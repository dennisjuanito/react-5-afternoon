...
function reducer(state = initialState, action) {
  ...
  switch (action.type) {
    ...
    case UPDATE_REAL_ESTATE_AGENT:
      return Object.assign({}, state, { found: action.realEstateAgent });
    case UPDATE_COST:
      return Object.assign({}, state, { found: action.cost });
    case UPDATE_DOWN_PAYMENT:
      return Object.assign({}, state, { found: action.downPayment });
    case UPDATE_CREDIT:
      return Object.assign({}, state, { found: action.credit });

    case UPDATE_HISTORY:
      return Object.assign({}, state, { found: action.history });
    case UPDATE_ADDRESS_ONE:
      return Object.assign({}, state, { found: action.addressOne });
    case UPDATE_ADDRESS_TWO:
      return Object.assign({}, state, { found: action.addressTwo });
    case UPDATE_ADDRESS_THREE:
      return Object.assign({}, state, { found: action.addressThree });
    case UPDATE_FIRST_NAME:
      return Object.assign({}, state, { found: action.firstName });
    case UPDATE_LAST_NAME:
      return Object.assign({}, state, { found: action.lastName });
    case UPDATE_EMAIL:
      return Object.assign({}, state, { found: action.email });
